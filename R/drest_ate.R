...
#' @param B A postive integer number of bootstrap samples - default is 1000.
#'
#' @return The returned value is an object of class `"double"`, containing 4 named components that follow. `Estimate`: the doubly robust point estimate of the ATE.
#' `StdError`: The standard error of the estimator, either using the asymptotic variance estimator or sample standard deviation of the bootstrap samples for the basic bootstrap interval. NA will be output
#' if either the percentile interval or BCa interval is specified. `Lower`, `Upper`: the lower and upper bounds of the confidence interval respectively.
#'
#'
